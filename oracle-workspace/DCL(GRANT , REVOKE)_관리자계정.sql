/*
    ...
    계정에서 시스템 권한 또는 객체접근 권한을 부여(GRANT)하거나 회수 하는 언어
...
-- 2. SAMPLE 계정에 접속하기 위한 CREATE SESSION 권한부여.
GRANT CREATE SESSION TO SAMPLE;

-- 3_1. SAMPLE계정에 테이블을 생성할 수 있는 CREATE TABLE 권한부여
...
-- 5. SAMPLE 계정에 KH.EMPLOYEE테이블을 조회할 수 있는 권한부여.
...
-- 6. SAMPLE계정에 KH.DEPARTMENT테이블에 행을 삽입할수 있는 권한 부여.
...
-- 7. SAMPLE계정에서 테이블을 생성할수 있는 권한 회수
